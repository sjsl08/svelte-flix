<script lang="ts">
  ...
  import { ChevronRight, Play, Plus, Check, ThumbsUp } from "lucide-svelte";
...
>
  ...
  <div class="relative w-full ">
    ...
    <div class="pointer-events-none">
      ...
      <Player bind:this={player} videoId={trailerUrl}/>
    </div>
  ...
  >
    ...
    <button
      ...
      class="rounded-full transition-colors duration-200 p-3 border-2 border-gray-700 hover:border-white"
    >
      <ChevronRight class="text-white h-6 w-6" />
    </button>
  </div>
